    ...
    <div className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden theme-transition bg-gray-900">
      ...
      <div className={`absolute inset-0 z-0 transition-opacity duration-1000 ease-in-out ${
        theme === 'myrtle' ? 'opacity-100 visible' : 'opacity-0 invisible'
         ...
         {/* Base Warmth - Lighter, cleaner base for multiply effect */}
         ...
         {/* Drifting "Leaf Shadows" and "Sunspots" */}
         {/* Lime/Green - The Leaf Canopy */}
         ...
         {/* Amber/Yellow - The Direct Sunlight */}
      ...
      <div className={`absolute inset-0 z-0 transition-opacity duration-1000 ease-in-out ${
        ...
        {/* Ethereal Nebulas (Additive Blending) - Slower, Deeper Colors */}
        {/* Deep Indigo Base */}
        ...
        {/* Static Noise for "Film Grain" look */}
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto mt-16">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a
            href="#muse"
            className={`px-10 py-4 rounded-sm font-bold uppercase tracking-widest text-xs transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 ${
              theme === 'myrtle'
                ? 'bg-transparent text-myrtle-text border border-myrtle-text/30 hover:border-myrtle-text'
                : 'bg-transparent text-white border border-white/20 hover:border-white/50'
            }`}
          >
            Talk to {theme === 'myrtle' ? 'Myrtle' : 'Mist'}
          </a>
        </div>
      </div>
